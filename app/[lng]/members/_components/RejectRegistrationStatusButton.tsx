...
export default function RejectRegistrationStatusButton({ resourceId }: { resourceId: string; }) {
    ...
    return (
        <form action={formAction}>
            ...
            <input type={`hidden`} id={`status`} name={`status`} value={RegistrationStatus['REJECTED']} />
            <Button
                className={`mt-4`}
                variant={`dark`}
